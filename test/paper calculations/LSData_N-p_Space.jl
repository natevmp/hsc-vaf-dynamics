...
VafFit = 1
_NDisc = range(Nmin, Nmax, length=7)
_pDisc = range(0.05, 0.99, length=4)



##
@time _N, _p, NOptInterpol_p, vaf1ErrorInterpol_p_N = InferencePipeline.calcNpSpace(paramsKnown, paramsEst, nVHSC_f, SCBurdenHSC_CID, _NDisc, _pDisc, lVfs, VafFit; verbose=true, cumulative=true)
