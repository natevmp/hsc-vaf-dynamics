...
data_name = string("../data/bottleneck/dataBIGrexp", "_N", params["N final"], "_mu", params["μ"],"_S", params["sample size"], "_t", tStop, "_gR", params["growth rate"], ".jld2")

@load data_name times_t nLive_t vaf_n vafB_n burden_m burdenB_m
...
plot(x ,vaf_n[end:-1:2]./vaf_n[2], seriestype = :scatter,ylims=(-0.05,1.05),label = string(" Full Pop"),legend=:topleft)
...
fig_name = string("../Figures/BigSim/BigSimRExpVAF_N",params["N final"], "_t", tStop,"_mu", params["μ"])
